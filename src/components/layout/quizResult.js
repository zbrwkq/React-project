...
const QuizResult = ({ questions, reponsesUser }) => {
    ...
    return (
        <div className="quiz-result">
          ...
          <div className="text-center">Score: {score}/{totalQuestions}</div>
                  ...
                  {question.reponses.map((reponse, reponseIndex) => (
                    <li
                      className={`reponse-item 
                        ${reponse.etat ? 'trueResponse' : reponseIndex === reponsesUser[index] ? 'falseResponse' : ''}`}
                      key={reponseIndex}
                    >
                      <div className="reponse-text">{reponse.reponse}</div>
                      {reponseIndex === reponsesUser[index] && reponse.etat && (
                        <div className="reponse-indicator"><FontAwesomeIcon className='iconQuiz' icon={faCheck} style={{color: "#fff",}} /></div>
                      )}
                      {reponseIndex === reponsesUser[index] && !reponse.etat && (
                        <div className="reponse-indicator"><FontAwesomeIcon className='iconQuiz' icon={faXmark} style={{color: "#fff",}} /></div>
                      )}
                      {reponseIndex !== reponsesUser[index] && reponse.etat && (
                        <div className="reponse-indicator"><span className='textBR'>Bonne réponse</span></div>
                      )}
                    </li>
                  ))}
                </ul>
